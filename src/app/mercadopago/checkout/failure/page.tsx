...
import styles from "@/app/styles/failureMp.module.css";
...
export default function FailurePage() {
  ...
  if (loading) return <p className={styles["loading"]}>Verificando pago...</p>;
  ...
  return (
    <div className={styles["failure-container"]}>
      <div className={styles["card"]}>
        <h1 className={styles["title"]}>❌ Pago rechazado</h1>
        <p className={styles["subtitle"]}>
          Lamentablemente tu pago no se pudo procesar.
        </p>
